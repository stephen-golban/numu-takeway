...
export function PortfolioHeader({
  ...
  if (isLoading) {
    return (
      <View className="items-center gap-2 py-6">
        <View className="h-4 w-24 animate-pulse rounded bg-muted" />
        <View className="h-10 w-40 animate-pulse rounded bg-muted" />
  ...
  return (
    <View className="items-center gap-1 py-6">
      ...
      <Text className="font-bold text-4xl tracking-tight">
